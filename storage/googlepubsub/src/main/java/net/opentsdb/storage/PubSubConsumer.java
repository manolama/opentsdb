...
public class PubSubConsumer implements TimeSeriesDataConsumer, MessageReceiver {
  ...
  public Deferred<Object> initialize(final TSDB tsdb) {
    ...
    System.out.println("SERDES PLUGIN: " + serdes);
    ...
    System.out.println("STORE: " + data_store);
    ...
    try {
      ...
      System.out.println("CREDS: " + credentials.getAccessToken());
      ...
      for (int i = 0; i < consumers; i++) {
        ...
        subscriber.startAsync().addListener(new Listener() {
...
System.out.println("TERMINATED the subscriber!");
          }
