...
public class PredictionTimeSeries implements TimeSeries {
  ...
  public PredictionTimeSeries(final TimeSeriesId id, 
  ...
  public PredictionTimeSeries(final TimeSeries source, 
                              final String suffix, 
                              final String model) {
    this.source = source;
