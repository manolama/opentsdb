...
import net.opentsdb.ql.ast.untyped.Equals;
 ...
 * BinaryOperator}.
 */
public class EqualsTest extends BinaryOperatorContractTestTemplate<Equals> {
  @Override
  public Equals makeOperator(
    final Node<UntypedVisitor> lhs, final Node<UntypedVisitor> rhs) {
    return new Equals(lhs, rhs);
  }

  @Override
  public Equals makeMockedOperator() {
    return mock(Equals.class);
  }
}
