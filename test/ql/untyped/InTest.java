...
import net.opentsdb.ql.ast.untyped.In;
 ...
 * BinaryOperator}.
 */
public class InTest extends BinaryOperatorContractTestTemplate<In> {
  @Override
  public In makeOperator(
    final Node<UntypedVisitor> lhs, final Node<UntypedVisitor> rhs) {
    return new In(lhs, rhs);
  }

  @Override
  public In makeMockedOperator() {
    return mock(In.class);
  }
}
