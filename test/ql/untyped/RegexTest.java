...
import net.opentsdb.ql.ast.untyped.Regex;
 ...
 * BinaryOperator}.
 */
public class RegexTest extends BinaryOperatorContractTestTemplate<Regex> {
  @Override
  public Regex makeOperator(
      final Node<UntypedVisitor> lhs, final Node<UntypedVisitor> rhs) {
      return new Regex(lhs, rhs);
  }

  @Override
  public Regex makeMockedOperator() {
    return mock(Regex.class);
  }
}
