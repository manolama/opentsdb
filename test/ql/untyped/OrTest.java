...
import net.opentsdb.ql.ast.untyped.Or;
 ...
 * BinaryOperator}.
 */
public class OrTest extends BinaryOperatorContractTestTemplate<Or> {
  @Override
  public Or makeOperator(
    final Node<UntypedVisitor> lhs, final Node<UntypedVisitor> rhs) {
    return new Or(lhs, rhs);
  }

  @Override
  public Or makeMockedOperator() {
    return mock(Or.class);
  }
}
