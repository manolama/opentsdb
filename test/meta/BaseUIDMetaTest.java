...
@PrepareForTest({TSDB.class, Config.class, UniqueId.class, HBaseClient.class, 
  ...
  TSUIDQuery.class})
public class BaseUIDMetaTest {
  protected static byte[] NAME_FAMILY = "name".getBytes(MockBase.ASCII());
  protected static byte[] TSUID = new byte[] { 0, 0, 1, 0, 0, 1, 0, 0, 1 };
  protected static byte[] TSUID2 = new byte[] { 0, 0, 1, 0, 0, 1, 0, 0, 2 };
  protected TSDB tsdb;
