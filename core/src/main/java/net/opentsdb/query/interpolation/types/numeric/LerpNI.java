...
public class LerpNI extends BaseTSDBPlugin implements NumericInterpolatorFactory {
  
  public static final String TYPE = "LERP";
  
  private static final NumericTypeInterpolator INTERPOLATOR = new LERP();
  
  private static class LERP implements NumericTypeInterpolator {
