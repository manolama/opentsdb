...
public class TestReadCacheQueryPlanner {
  ...
  public void oneMetricAlone() throws Exception {
    ...
    ReadCacheQueryPlanner planner = 
        new ReadCacheQueryPlanner(context, SINK);
    ...
    query = SemanticQuery.newBuilder()
        ...
        .build();
    when(context.query()).thenReturn(query);
    planner = new ReadCacheQueryPlanner(context, SINK);
    planner.plan(null).join();
    assertEquals(1, planner.serializationSources().size());
  }
...
//  }
  ...
  public void summaries() throws Exception {
    final String json = "{\"start\": \"1h-ago\",\"executionGraph\": [{\"id\": \"q1_m1\",\"type\": \"TimeSeriesDataSource\",\"metric\": {\"type\": \"MetricLiteral\",\"metric\": \"Yamas.tsdb.query.user.latency.0_10\"},\"sourceId\": null,\"fetchLast\": false,\"filterId\": \"filter-arz\"}, {\"id\": \"q1_m1_downsample\",\"type\": \"downsample\",\"aggregator\": \"avg\",\"interval\": \"auto\",\"runAll\": false,\"fill\": true,\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m1\"]}, {\"id\": \"q1_m1_groupby\",\"type\": \"groupby\",\"aggregator\": \"sum\",\"tagKeys\": [],\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m1_downsample\"]}, {\"id\": \"q1_m2\",\"type\": \"TimeSeriesDataSource\",\"metric\": {\"type\": \"MetricLiteral\",\"metric\": \"Yamas.tsdb.query.user.latency.10000_30000\"},\"sourceId\": null,\"fetchLast\": false,\"filterId\": \"filter-arz\"}, {\"id\": \"q1_m2_downsample\",\"type\": \"downsample\",\"aggregator\": \"avg\",\"interval\": \"auto\",\"runAll\": false,\"fill\": true,\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m2\"]}, {\"id\": \"q1_m2_groupby\",\"type\": \"groupby\",\"aggregator\": \"sum\",\"tagKeys\": [],\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m2_downsample\"]}, {\"id\": \"q1_m3\",\"type\": \"TimeSeriesDataSource\",\"metric\": {\"type\": \"MetricLiteral\",\"metric\": \"Yamas.tsdb.query.user.latency.750_1000\"},\"sourceId\": null,\"fetchLast\": false,\"filterId\": \"filter-arz\"}, {\"id\": \"q1_m3_downsample\",\"type\": \"downsample\",\"aggregator\": \"avg\",\"interval\": \"auto\",\"runAll\": false,\"fill\": true,\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m3\"]}, {\"id\": \"q1_m3_groupby\",\"type\": \"groupby\",\"aggregator\": \"sum\",\"tagKeys\": [],\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m3_downsample\"]}, {\"id\": \"q1_m4\",\"type\": \"TimeSeriesDataSource\",\"metric\": {\"type\": \"MetricLiteral\",\"metric\": \"Yamas.tsdb.query.user.latency.50_100\"},\"sourceId\": null,\"fetchLast\": false,\"filterId\": \"filter-arz\"}, {\"id\": \"q1_m4_downsample\",\"type\": \"downsample\",\"aggregator\": \"avg\",\"interval\": \"auto\",\"runAll\": false,\"fill\": true,\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m4\"]}, {\"id\": \"q1_m4_groupby\",\"type\": \"groupby\",\"aggregator\": \"sum\",\"tagKeys\": [],\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"sources\": [\"q1_m4_downsample\"]}, {\"id\": \"topn-q1_m4_groupby\",\"type\": \"topn\",\"sources\": [\"q1_m4_groupby\"],\"aggregator\": \"sum\",\"top\": true,\"count\": 10},{\"id\": \"q1_e1\",\"type\": \"expression\",\"expression\": \" q1_m1  +  q1_m2 \",\"join\": {\"type\": \"Join\",\"joinType\": \"NATURAL_OUTER\",\"joins\": {\"colo\": \"colo\"}},\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"infectiousNan\": false,\"substituteMissing\": true,\"variableInterpolators\": {},\"sources\": [\"q1_m1_groupby\", \"q1_m2_groupby\"]}, {\"id\": \"q1_e2\",\"type\": \"expression\",\"expression\": \" q1_m3  +  q1_m4 \",\"join\": {\"type\": \"Join\",\"joinType\": \"NATURAL_OUTER\",\"joins\": {\"colo\": \"colo\"}},\"interpolatorConfigs\": [{\"dataType\": \"numeric\",\"fillPolicy\": \"NAN\",\"realFillPolicy\": \"NONE\"}],\"infectiousNan\": false,\"substituteMissing\": true,\"variableInterpolators\": {},\"sources\": [\"q1_m3_groupby\", \"topn-q1_m4_groupby\"]}, {\"id\": \"summarizer\",\"sources\": [\"q1_e1\", \"q1_e2\"],\"summaries\": [\"avg\", \"max\", \"min\", \"count\", \"sum\", \"first\", \"last\"]}],\"filters\": [{\"filter\": {\"type\": \"Chain\",\"op\": \"AND\",\"filters\": [{\"type\": \"Chain\",\"op\": \"OR\",\"filters\": [{\"type\": \"TagValueLiteralOr\",\"filter\": \"prod-api|prod|prod-alerts\",\"tagKey\": \"environment\"}]}, {\"type\": \"TagValueLiteralOr\",\"filter\": \"middletier\",\"tagKey\": \"role\"}]},\"id\": \"filter-arz\"}],\"serdesConfigs\": [{\"id\": \"JsonV3QuerySerdes\",\"filter\": [\"q1_e1\", \"q1_e2\",\"summarizer\"]}],\"logLevel\": \"ERROR\",\"cacheMode\": null}";
    SemanticQuery query = SemanticQuery.parse(TSDB, JSON.getMapper().readTree(json)).build();
    when(context.query()).thenReturn(query);
