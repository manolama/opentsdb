...
public class TestCombinedResult {
  ...
  public void emptyResults() throws Exception {
    CombinedResult result = new CombinedResult(context, new QueryResult[0], 
        node, data_source, sinks, latch, "1h");
  ...
  public void resultsAllEmpty() throws Exception {
    ...
    CombinedResult result = new CombinedResult(context, results, 
        node, data_source, sinks, latch, "1h");
