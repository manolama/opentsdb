...
//    System.out.println("COPYING       NEW STRING: " + new String(buffer, start, end - start));
//    if (measurementIndex + (end - start) >= metric_buffer.length) {
//      byte[] temp = new byte[metric_buffer.length * 2];
//      System.arraycopy(metric_buffer, 0, temp, 0, measurementIndex);
//      metric_buffer = temp;
//    }
//    
//    System.arraycopy(buffer, start, metric_buffer, measurementIndex, end - start);
//    metricBytes = measurementIndex + (end - start);
//  }
//  
