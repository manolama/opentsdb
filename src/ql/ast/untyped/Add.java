...
/**
 * Representation of the addition operator in a expression.
 *
 * @since 2.3
 */
public class Add extends BinaryOperator<UntypedVisitor> {
  public static final String SYMBOL = "+";

  /**
   * Construct a new addition-operator instance.
   *
   * @param lhs Left-hand side expression.
   * @param rhs Right-hand side expression.
   */
  public Add(
    final Node<UntypedVisitor> lhs,
    final Node<UntypedVisitor> rhs) {
