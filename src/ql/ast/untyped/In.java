...
/**
 * Representation of a set-membership operator in a filter.
 *
 * @since 2.3
 */
public class In extends BinaryOperator<UntypedVisitor> {
  public static final String SYMBOL = "in";

  /**
   * Construct a new set-membership-operator instance.
   *
   * @param lhs Left-hand side expression.
   * @param rhs Right-hand side expression.
   */
  public In(final Node<UntypedVisitor> lhs, final Node<UntypedVisitor> rhs) {
